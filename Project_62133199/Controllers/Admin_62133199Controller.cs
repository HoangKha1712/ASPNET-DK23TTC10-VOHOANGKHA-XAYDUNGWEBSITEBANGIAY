...
namespace Project_62133199.Controllers
{
    ...
    public class Admin_62133199Controller : Controller
    {
            ...
            try
            {
                ...
                if (ModelState.IsValid && AdminLogin != null)
                {
                    if (AdminLogin.TrangThai == true)// tài khoản không bị ban
                    {
                        ...
                        return RedirectToAction("Index", "Admin_62133199");
                    }
                    else { return Content("<script>alert('Tài khoản quản trị của bạn đã bị khóa!');window.location='/Admin_62133199/Login';</script>"); }
                }
                else { return Content("<script>alert('Tên đăng nhập hoặc mật khẩu không đúng!');window.location='/Admin_62133199/Login';</script>"); }
            }
            catch
            {
                return Content("<script>alert('Đăng nhập thất bại!');window.location='/Admin_62133199/Login';</script>");
            }
        }
        #endregion
        #region Đăng xuất
        ...
        public ActionResult Account(FormCollection collection)
        {
            try
            {
                ...
                if (FileUpload != null && FileUpload.ContentLength > 0)//Kiểm tra đã chọn 1 file Upload để thực hiện tiếp
                {
                    ...
                    {
                        return Content("<script>alert('Kích thước của tập tin không được vượt quá 1 MB!');window.location='/Admin_62133199/Account';</script>");
                    }
                    ...
                    {
                        return Content("<script>alert('Chỉ được tải tập tin hình ảnh dạng (.jpg, .jpeg, .png, .gif)!');window.location='/Admin_62133199/Account';</script>");
                    }
                ...
                UpdateModel(ttad);
                data.SubmitChanges();
                return Content("<script>alert('Cập nhật thông tin cá nhân thành công!');window.location='/Admin_62133199/Account';</script>");
            }
            catch
            {
                return Content("<script>alert('Lỗi hệ thống.Vui lòng thử lại!');window.location='/Admin_62133199/Account';</script>");
            }
        }
        #endregion
                ...
                if (ad.MatKhau == _PassOld)
                {
                    if (_RePassNew == _PassNew)
                    {
                        if (_PassNew.Length >= 6)
                        {
                            ...
                            UpdateModel(ad);
                            data.SubmitChanges();
                            return Content("<script>alert('Đổi mật khẩu thành công!');window.location='/Admin_62133199/ChangePassword';</script>");
                        }
                        else
                            return Content("<script>alert('Mật khẩu mới phải có ít nhất 6 ký tự!');window.location='/Admin_62133199/ChangePassword';</script>");
                    }
                    else
                        return Content("<script>alert('Mật khẩu nhập lại không đúng!');window.location='/Admin_62133199/ChangePassword';</script>");
                }
                else
                    return Content("<script>alert('Mật Khẩu cũ không đúng!');window.location='/Admin_62133199/ChangePassword';</script>");
            }
            catch
            {
                return Content("<script>alert('Thao tác đổi mật khẩu thất bại!');window.location='/Admin_62133199/ChangePassword';</script>");
            }
        }
        #endregion
        ...
        public ActionResult ListAdmin(int? page)
        {
            ...
            {
                return Content("<script>alert('Bạn không đủ quyền hạn vào khu vực quản trị Administrator !');window.location='/Admin_62133199/';</script>");
            }
        ...
        public ActionResult CreateAdmin(FormCollection collection, QUANLY ad, PHANQUYEN pq)
        {
            try
            {
                ...
                if (CheckUser != null)
                {
                    return Content("<script>alert('Tên đăng nhập đã có người sử dụng!');window.location='/Admin_62133199/CreateAdmin';</script>");
                }
                else
                {
                ...
                if (RePassword != Password)
                    return Content("<script>alert('Mật khẩu nhập lại không đúng!');window.location='/Admin_62133199/CreateAdmin';</script>");
                else
                {
                    matkhau_mahoa = Md5_62133199.MaHoaMD5(Password);
                    ad.MatKhau = matkhau_mahoa;
                }
                var CheckEmail = data.QUANLies.FirstOrDefault(a => a.EmailQL == Email);
                if (CheckEmail != null)
                {
                    return Content("<script>alert('Email đã có người sử dụng!');window.location='/Admin_62133199/CreateAdmin';</script>");
                }
                else
                {
                    ad.EmailQL = Email;
                ...
                if (FileUpload != null && FileUpload.ContentLength > 0)
                {
                    ...
                    if (FileUpload.ContentLength > 1 * 1024 * 1024)
                    {
                        return Content("<script>alert('Kích thước của tập tin không được vượt quá 1 MB!');window.location='/Admin_62133199/CreateAdmin';</script>");
                    }
                    var DuoiFile = new[] { "jpg", "jpeg", "png", "gif" };
                    var FileExt = Path.GetExtension(FileUpload.FileName).Substring(1);
                    if (!DuoiFile.Contains(FileExt))
                    {
                        return Content("<script>alert('Bảo mật Website! Chỉ được Upload tập tin hình ảnh dạng (.jpg, .jpeg, .png, .gif)!');window.location='/Admin_62133199/CreateAdmin';</script>");
                    }
                ...
                data.SubmitChanges();
                return Content("<script>alert('Thêm mới tài khoản quản trị thành công !');window.location='/Admin_62133199/ListAdmin';</script>");
            }
            catch
            {
                return Content("<script>alert('Đăng ký thất bại.Hệ thống gặp vấn đề');window.location='/Admin_62133199/CreateAdmin';</script>");
            }
        }
        #endregion
        #endregion
        ...
        public ActionResult SanPham(int? page)
        {
            ...
            {
                return Content("<script>alert('Bạn không đủ quyền hạn vào khu vực quản lý sản phẩm !');window.location='/Admin_62133199/';</script>");
            }
        ...
        public ActionResult Ykienkhachhang(int? page)
        {
            ...
            {
                return Content("<script>alert('Bạn không đủ quyền hạn vào khu vực này !');window.location='/Admin_62133199/';</script>");
            }
            int pageNumber = (page ?? 1);
            int pageSize = 5;
        ...
        public ActionResult Order(int? page)
        {
            if (Session["Username_Admin"] == null)//Chưa đăng nhập 
                ...
                return Content("<script>alert('Bạn không đủ quyền hạn vào khu vực quản trị Đơn Hàng !');window.location='/Admin_62133199/';</script>");
