...
{
    public class User_62133199Controller : Controller
    {
        // GET: User
        ...
        public ActionResult Dangky(FormCollection collection, KHACHHANG kh)
        {
            ...
            {
                matkhau_mahoa = Md5_62133199.MaHoaMD5(matkhau);
                kh.HoTen = hoten;
                kh.TaiKhoanKH = tendn;
        ...
        public ActionResult Dangnhap(FormCollection collection)
        {
            var tendn = collection["TenDN"];
            var matkhau = collection["MatKhau"];
            var matkhau_mahoa = Md5_62133199.MaHoaMD5(matkhau);
        ...
        public ActionResult DoiMatKhau(FormCollection collection)
        {
            ...
            else if (!String.Equals(Md5_62133199.MaHoaMD5(oldPassword), user.MatKhau)) // kiểm tra mật khẩu cũ
            {
            ...
            {
                newPassword = Md5_62133199.MaHoaMD5(newPassword);
        ...
        public ActionResult UpdateProfile(int id)   
        {
            ...
            data.SubmitChanges();
            Session["Taikhoan"] = kh;
            return Content("<script>alert('Thay đổi thông tin thành công');window.location='/User_62133199/MyProfile/" + kh.MaKH + "';</script>");
        }
    }
}